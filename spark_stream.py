...
def insert_data(session, **kwargs):
    ...
    try:
        session.execute("""
            INSERT INTO spark_streams.weather_data(id, city, region, latitude, longitude, temp_c, 
                last_updated, condition, humidity, feelslike_c)
                VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
        """, (weather_id, city, region, latitude, longitude, temp_c,
              last_updated, condition, humidity, feelslike_c))
        logging.info(f"Data inserted for {city}")
